...
<?php
        include'./config.php';
        $result = mysqli_query($conn,"SELECT * FROM lichchieu order by Ngay DESC");
        mysqli_close($conn);
    ?>

    <div style="padding: 50px">
    <h1 style="text-align: center;">LỊCH CHIẾU PHIM</h1>
    <h5 style="text-align: center;"><a href="./addlichchieuphim.php">Thêm lịch chiếu phim</a></h5>
            ...
            <tr>
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    <tr>
                        ...
                        <th style="font-weight: 100;"><?=$row['TenRap']?></th>
                        <th style="font-weight: 100;"><?=$row['LoaiVe']?></th>
                        <th style="font-weight: 100;"><?=$row['Ngay']?></th>
                        <th style="font-weight: 100;"><?=$row['Gio']?></th>
