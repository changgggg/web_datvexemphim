...
<body>
    ...
    <h1 style="text-align: center;">THÔNG TIN KHÁCH HÀNG</h1><br>
    ...
    <table class="table table-striped b-t b-light">
                ...
                while($row = mysqli_fetch_array($result)){
                    ...
                    <tr>
                        ...
                        <th style="font-weight: 100;"><?=$row['username']?></th>
                        <th style="font-weight: 100;"><?=$row['phone']?></th>
                        <th style="font-weight: 100;"><?=$row['email']?></th>
                        <!-- <th><a href="./edit_user.php?id=<?= $row['id']?>">Sửa</a></th>
                        <th><a href="./delete_user.php?id=<?= $row['id']?>">Xóa</a></th> -->
                    </tr>
